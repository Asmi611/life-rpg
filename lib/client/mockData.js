...
// hotspot values match the real starter-quest keys seeded server-side
// (academy, trainingGround, farm, library, workshop) so mock and live data
// route to the same village hotspots without a separate mapping.
